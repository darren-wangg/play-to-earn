...
export default function BetList({ refreshKey }: { refreshKey: number }) {
  ...
  if (!session) {
    return (
      <div className="animate-fade-in rounded-xl border border-dashed border-zinc-300 bg-zinc-50 p-6 text-center dark:border-zinc-700 dark:bg-zinc-900">
    ...
    <div className="stagger-children space-y-3">
      {bets.map((bet) => {
        ...
        return (
          <div
            key={bet._id}
            className="rounded-xl border border-zinc-200 bg-white p-4 transition-shadow hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900 sm:p-5"
          >
